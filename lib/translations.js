export const translations = {
  site: {
    title: "Access'ouaf",
    description:
      "Access'ouaf est un site de petites annonces pour animaux de compagnie.",
  },
  header: {
  ...
  loginPage: {
    titleLogin: "Connectez-vous",
    titleRegister: "Créez-vous un compte"
  },
  login: {
    ...
    displayForgotPassword: "Mot de passe oublié ?",
    forgotPasswordButton: "Envoyer",
    forgotPasswordText: "Renseignez votre adresse mail pour déclencher la réinitialisation de votre mot de passe.",
    forgotPasswordSend: "Un mail de réinitialisation a été envoyé sur l'adresse mail que vous avez renseigné. Veuillez suivre les étapes indiquées dans celui-ci."
  },
  register: {
  ...
  resetPassword: {
    ...
    text: "Veuillez renseigner votre nouveau mot de passe.",
    successTitle: "Mot de passe mis à jour",
    successText: "Vous pouvez désormais vous connecter avec votre nouveau mot de passe."
  },
  dashboard: {
    ...
    accountPage: {
      ...
      userAccountComponent: {
        ...
        avatarEmptyTemplate: "Glissez une image ou choisissez-en une",
        avatarChooseLabel: "Choisir",
        avatarUploadLabel: "Envoyer",
        avatarCancelLabel: "Annuler",
        invalidFileSizeMessageSummary: "Taille du fichier invalide",
        invalidFileSizeMessgage: "La taille maximale autorisée est de 4.768 MB",
        nameLabel: "Nom",
        emailLabel: "Email",
    ...
    animalPage: {
      ...
      dialogMessage: 'Êtes-vous sûr de supprimer cet animal de votre profil ?',
      acceptLabel: 'Oui',
      rejectLabel: 'Non',
      animalSheetForm: {
        headerCreate: "Nouvel animal",
        headerEdit: "Modifier un animal",
        loginErrorMessage: "Vous devez être connecté pour créer un profil d'animal",
        errorMessage: "Une erreur est survenue lors de l'enregistrement de la fiche",
        ...
        speciesHorse: "Cheval",
        speciesOther: "Autre",
        submitButtonCreate: "Créer la fiche",
        submitButtonEdit: "Modifier la fiche",
  ...
  titles: {
    category: "Catégorie",
    searchProducts: "Produits recherchés"
  },
  text: {
    results: "résultats",
    result: "résultat",
